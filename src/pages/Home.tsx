    ...
    <div className="space-y-5">
      ...
      >
        <div className="text-center py-12">
          ...
          <div className="font-mono text-5xl font-medium text-[var(--text)] tracking-wide mb-1">
            {formatTime(time)}
          </div>
          ...
          {weather && (
            <div className="text-sm text-[var(--text-2)] flex items-center justify-center gap-1.5">
              {weather.icon} <span className="font-medium text-[var(--text)]">{weather.temp}°C</span>
            </div>
          )}
      ...
      <GlassCard>
        <div className="flex justify-between items-center mb-2">
          ...
          <button
            onClick={() => { setNotes(''); storage.remove('notes') }}
            className="font-mono text-xs text-[var(--text-3)] bg-none border-none cursor-pointer hover:text-[var(--text-2)]"
          >
            {_('clear')}
          </button>
        </div>
